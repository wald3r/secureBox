            ...
            <thead className='thead-dark'>
                ...
                <tbody width="10">
                  <tr>
                    ...
                    <td>
                      <input autoComplete='off' defaultValue={user.username} onChange={handleUsernameChange}/>
                    </td>
                  </tr>
                  <tr>
                    <td width="10">
                  ...
                  <tr>
                    ...
                    <td>
                      <input autoComplete='off' defaultValue={user.email} onChange={handleMailChange}/>
                    </td>
                  </tr>
                  <tr>
                    <td width="10">
